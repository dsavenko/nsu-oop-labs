...
2. `<TICKER>` - строка, биржевой тикер (краткое название акции). Используйте реальные значения. Взять их можно, например, [отсюда](https://github.com/rreichel3/US-Stock-Symbols/blob/main/all/all_tickers.txt). Не нужно использовать их все, выберите небольшое подмножество (несколько сотен).
