...
2. JavaFX
3. SWT
4. [libGDX](https://libgdx.com/) - полноценный фреймворк для создания игр на Java. Подойдет тем, кому интересен геймдев, но может потребовать больше времени на освоение.
