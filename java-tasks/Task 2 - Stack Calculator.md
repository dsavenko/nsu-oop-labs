...
4. Разработать иерархию исключений, которые будут выбрасывать команды при исполнении. В случае возникновения исключения — выводить информацию об ошибке
...
6. Соберите 2 jar-файла: в одном будет вся программа, за исключением команд, в другом - команды. Продемонстрируйте:
