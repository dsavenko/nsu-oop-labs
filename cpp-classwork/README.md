...
4. Создайте объект класса `Chimera`. Выведите его значение `counter`. Замените виртуальное наследование на обучное и проверьте, как изменится значение `counter`.
