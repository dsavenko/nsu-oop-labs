...
1. Подзадача 1 (без допов) обязательна для всех.
2. На оценку 3 достаточно сделать (без допов) подзадачи 1 и 2.
3. На оценку 5 обязательно сделать все 3 подзадачи (их минимальные условия) + хорошее количество допов (можно не все, по ситуации).
