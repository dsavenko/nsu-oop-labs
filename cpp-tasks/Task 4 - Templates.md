...
Подзадача 1 (без допов) обязательна для всех. На "тройку" достаточно сделать (без допов) подзадачи 1 и 2. На "пятерку" обязательно сделать все 3 подзадачи (их минимальные условия) + хорошее количество допов. На "4" и "5" допы можно выбирать свободно из разных подзадач.
