...
> [!TIP]
> Для сборки проекта и запуска тестов вы можете воспользоваться CMake. Шаблон проекта для CMake с описанием, как все настроить, см. [здесь](https://github.com/dsavenko/nsu-oop-cpp-template). В шаблоне для CMake GoogleTest уже подключен, вам лишь нужно их написать.
...
2. Сделайте так, чтобы все методы вашего класса обеспечивали как минимум [базовую гарантию безопасности исключений](https://habr.com/ru/articles/126374/). Примените идиому [Copy-and-swap](https://ru.wikipedia.org/wiki/Copy-and-swap).
